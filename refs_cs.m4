...
define([intro.mc.cs.anch.CODE_M4([[]]) C[,] JSON[,] INI – CODE([DQ()řetězec[]DQ()])], [c-json-ini-retezec])
define([intro.mc.cs.uniq.CODE_M4([[]]) C[,] JSON[,] INI – CODE([DQ()řetězec[]DQ()])])
define([intro.mc.cs.anch.CODE_M4([[]]) Bash CODE([CMD() echo []DQ()řetězec[]DQ()])], [bash-cmd-echo-retezec])
