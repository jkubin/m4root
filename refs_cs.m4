...
define([intro.mc.cs.anch.CODE_M4([[]]) Bash CODE([PROMPT() echo []DQ()řetězec[]DQ()])], [m4-bash-echo-dretezecd])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash CODE([PROMPT() echo []DQ()řetězec[]DQ()])])
define([intro.mc.cs.anch.CODE_M4([[]]) Bash CODE([PROMPT() echo 'řetězec'])], [m4-bash-echo-aretezeca])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash CODE([PROMPT() echo 'řetězec'])])
