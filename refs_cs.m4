...
define([intro.mc.cs.anch.common_code], [common-code])
...
define([intro.mc.cs.anch.all_context_free_grammar_rules], [all-context-free-grammar-rules])
...
define([intro.mc.cs.anch.nearly_forgotten_language], [nearly-forgotten-language])
...
define([intro.mc.cs.anch.maintenance_could_be_hard], [maintenance-could-be-hard])
