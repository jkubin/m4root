...
define([intro.mc.cs.anch.CODE_M4([[]]) Bash – CODE([[]DQ()řetězec[]DQ()])], [bash-retezec])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash – CODE([[]DQ()řetězec[]DQ()])])
define([intro.mc.cs.anch.CODE_M4([[]]) Bash – CODE(['řetězec'])], [bash-aretezeca])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash – CODE(['řetězec'])])
