...
define([intro.mc.cs.anch.CODE_M4([[]]) conv_file CSV[,] M4 (všechny znaky vrátí zpátky)], [prevodni-soubor-pro-csv-m4-vsech])
define([intro.mc.cs.uniq.CODE_M4([[]]) conv_file CSV[,] M4 (všechny znaky vrátí zpátky)])
