...
define([intro.mc.cs.anch.Historie M4], [historie-m4])
define([intro.mc.cs.uniq.Historie M4])
...
define([intro.mc.cs.capt.main_use_of_m4], [Hlavní použití M4])
define([intro.mc.cs.anch.main_use_of_m4], [hlavni-pouziti-m4])
...
define([intro.mc.cs.anch.CODE([💡], [jak to udělat]) Úprava speciálních znaků], [uprava-specialnich-znaku])
define([intro.mc.cs.uniq.CODE([💡], [jak to udělat]) Úprava speciálních znaků])
define([intro.mc.cs.capt.modified_input_source_code], [Upravený vstupní zdrojový kód])
define([intro.mc.cs.anch.modified_input_source_code], [upraveny-vstupni-zdrojovy-kod])
define([intro.mc.cs.uniq.Upravený vstupní zdrojový kód])
define([intro.mc.cs.anch.CODE_M4([[]]) XML[,] HTML – soubor pro značkovací jazyky], [xml-html-soubor-pro-znackovaci-j])
define([intro.mc.cs.uniq.CODE_M4([[]]) XML[,] HTML – soubor pro značkovací jazyky])
define([intro.mc.cs.anch.CODE_M4([[]]) C[,] JSON[,] INI – soubor pro DQ()řetězce v uvozovkách[]DQ()], [c-json-ini-soubor-pro-retezce-v])
define([intro.mc.cs.uniq.CODE_M4([[]]) C[,] JSON[,] INI – soubor pro DQ()řetězce v uvozovkách[]DQ()])
define([intro.mc.cs.anch.CODE_M4([[]]) Bash – soubor pro DQ()řetězce v uvozovkách[]DQ()], [bash-soubor-pro-retezce-v-uvozov])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash – soubor pro DQ()řetězce v uvozovkách[]DQ()])
define([intro.mc.cs.anch.CODE_M4([[]]) Bash – soubor pro 'řetězce v apostrofech'], [bash-soubor-pro-aretezce-v-apost])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash – soubor pro 'řetězce v apostrofech'])
...
define([intro.mc.cs.anch.CODE_M4([[]]) Bash – CODE([echo "řetězec"])], [bash-echo-retezec])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash – CODE([echo "řetězec"])])
define([intro.mc.cs.anch.CODE_M4([[]]) Bash – CODE([echo 'řetězec'])], [bash-echo-aretezeca])
define([intro.mc.cs.uniq.CODE_M4([[]]) Bash – CODE([echo 'řetězec'])])
...
define([intro.mc.cs.capt.m4_on_examples], [Jazyk M4 na příkladech])
define([intro.mc.cs.anch.m4_on_examples], [jazyk-m4-na-prikladech])
define([intro.mc.cs.uniq.Jazyk M4 na příkladech])
...
define([intro.mc.cs.capt.questions_and_answers], [Proč používat M4 a proč ne?])
define([intro.mc.cs.anch.questions_and_answers], [proc-pouzivat-m4-a-proc-ne])
define([intro.mc.cs.uniq.Proč používat M4 a proč ne?])
