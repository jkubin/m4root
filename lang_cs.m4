...
define(⟦NOSCRIPT_MESSAGE⟧,	⟦Srozumitelnost ukázek zdrojového kódu zvyšuje povolený JavaScript.⟧)
...
define(⟦WORD_ARTICLE_C⟧,	⟦vygenerovaný zdrojový kód C⟧)
...
define(⟦WORD_PUBLISH_TEXT⟧,	⟦vygenerovaný text, který právě čtete a který byl vložen do redakčního systému (CMS) serveru ⟧defn(⟦FAVORITE_SERVER_NAME⟧))
