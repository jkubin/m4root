...
define([TITLE],				defn([MULTILINGUAL_HEADINGS], [ANCHORS_SED], [EXECUTE_SED], [TEST_RESULT], [SET_UNIQ_KEY_FOR_LINK], [PRINT_ITEMS]))
define([TITLE_MONO],			defn([MONOLINGUAL_HEADINGS], [ANCHORS_SED], [EXECUTE_SED], [TEST_RESULT], [SET_UNIQ_KEY_FOR_LINK], [PRINT_ITEMS]))
