...
define([intro.mc.en.anch.History of M4], [history-of-m4])
define([intro.mc.en.uniq.History of M4])
...
define([intro.mc.en.capt.main_use_of_m4], [Main uses of M4])
define([intro.mc.en.anch.main_use_of_m4], [main-uses-of-m4])
...
define([intro.mc.en.anch.CODE([💡], [how to do it]) Modification of special characters], [modification-of-special-characte])
define([intro.mc.en.uniq.CODE([💡], [how to do it]) Modification of special characters])
define([intro.mc.en.capt.modified_input_source_code], [Modified input source code])
define([intro.mc.en.anch.modified_input_source_code], [modified-input-source-code])
define([intro.mc.en.uniq.Modified input source code])
define([intro.mc.en.anch.CODE_M4([[]]) XML[,] HTML – the file for markup languages], [xml-html-the-file-for-markup-lan])
define([intro.mc.en.uniq.CODE_M4([[]]) XML[,] HTML – the file for markup languages])
define([intro.mc.en.anch.CODE_M4([[]]) C[,] JSON[,] INI – the file for DQ()strings in double quotes[]DQ()], [c-json-ini-the-file-for-strings])
define([intro.mc.en.uniq.CODE_M4([[]]) C[,] JSON[,] INI – the file for DQ()strings in double quotes[]DQ()])
define([intro.mc.en.anch.CODE_M4([[]]) Bash – the file for DQ()strings in double quotes[]DQ()], [bash-the-file-for-strings-in-dou])
define([intro.mc.en.uniq.CODE_M4([[]]) Bash – the file for DQ()strings in double quotes[]DQ()])
define([intro.mc.en.anch.CODE_M4([[]]) Bash – the file for 'strings in apostrophes'], [bash-the-file-for-astrings-in-ap])
define([intro.mc.en.uniq.CODE_M4([[]]) Bash – the file for 'strings in apostrophes'])
...
define([intro.mc.en.anch.CODE_M4([[]]) Bash – CODE([echo "string"])], [bash-echo-string])
define([intro.mc.en.uniq.CODE_M4([[]]) Bash – CODE([echo "string"])])
define([intro.mc.en.anch.CODE_M4([[]]) Bash – CODE([echo 'string'])], [bash-echo-astringa])
define([intro.mc.en.uniq.CODE_M4([[]]) Bash – CODE([echo 'string'])])
