...
define([intro.mc.en.anch.CODE_M4([[]]) C[,] JSON[,] INI – CODE([DQ()string[]DQ()])], [c-json-ini-string])
define([intro.mc.en.uniq.CODE_M4([[]]) C[,] JSON[,] INI – CODE([DQ()string[]DQ()])])
define([intro.mc.en.anch.CODE_M4([[]]) Bash – CODE([[]DQ()string[]DQ()])], [bash-string])
define([intro.mc.en.uniq.CODE_M4([[]]) Bash – CODE([[]DQ()string[]DQ()])])
define([intro.mc.en.anch.CODE_M4([[]]) Bash – CODE(['string'])], [bash-astringa])
define([intro.mc.en.uniq.CODE_M4([[]]) Bash – CODE(['string'])])
...
define([intro.mc.en.anch.CODE_M4([[]]) Bash CODE([CMD() echo []DQ()string[]DQ()])], [bash-cmd-echo-string])
