...
define([intro.mc.en.anch.CODE([💡], [solution]) Modification of special characters], [modification-of-special-characte])
define([intro.mc.en.uniq.CODE([💡], [solution]) Modification of special characters])
