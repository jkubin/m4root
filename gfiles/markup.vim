...
iabbrev <buffer> <unique> com COMMENT_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> divm DIV_MONO(⟦⟦<cr><cr>⟧⟧)dnl DIV_MONO<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> diw DIV_WRAP(⟦<cr><cr><cr><cr>⟧)dnl DIV_WRAP<up><up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dld DESCRIPTION_LIST_DESC(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dldm DESCRIPTION_LIST_DESC_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dlt DESCRIPTION_LIST_TERM(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dltm DESCRIPTION_LIST_TERM_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dlw DESCRIPTION_LIST_WRAP(⟦<cr><cr><cr><cr>⟧)dnl DESCRIPTION_LIST_WRAP<up><up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dm DIV_MONO(⟦⟦<cr><cr>⟧⟧)dnl DIV_MONO<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dq ⟦⟧DQ()<c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dv DIV(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> im IMAGEDATA(⟦⟧,dnl id<cr>⟦%%%⟧,dnl title<cr>⟦⟧,dnl class<cr>⟦⟧,dnl style<cr>⟦⟧,dnl anything<cr>⟦%%%, %%%⟧,dnl ⟦local_img, server_img⟧<cr>⟦⟦<cr>%%%<cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<right><right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> inf INFO(, defn(⟦WORD_INFORMATION⟧), ⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> lim LISTITEM_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> lit LISTITEM(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)dnl LISTITEM<up><up><up><up><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> navm NAV_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> nav NAV(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> nb ⟦⟧NB()<esc>
iabbrev <buffer> <unique> ntm NOTE_MONO(, defn(⟦WORD_NOTE⟧), ⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> nt NOTE(, defn(⟦WORD_NOTE⟧), ⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> pa PARA(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> par PARA(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pe PERSON(⟦<c-r>"⟧)<esc>
iabbrev <buffer> <unique> plm PLAIN_TEXT_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pl PLAIN_TEXT(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pm PARA_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pp PARA(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
"iabbrev <buffer> <unique> pp P(⟦⟧)%%%<c-o>T(<right><c-r>=Eatchar('.')<cr>
"iabbrev <buffer> <unique> prl PRE_LANG(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> summ SUMMARY_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> sum SUMMARY(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> til TILE_BOX(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> wa WARN(, defn(⟦WORD_WARNING⟧), ⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> wb ⟦⟧WBR()<c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> ww WARN(, defn(⟦WORD_WARNING⟧), ⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> xs XSPAN(⟦<c-r>"⟧, ⟦%%%⟧, ⟦%%%⟧)<left><c-o>%;;<c-r>=Eatchar('.')<cr>

iabbrev <buffer> <unique> enh ENTRY_HEAD(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> enhm ENTRY_HEAD_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> ent ENTRY(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> entm ENTRY_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> tti TTITLE(⟦⟦<cr><cr>⟧,dnl _next_language_<cr>⟦<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> ttm TTITLE_MONO(⟦⟦<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
