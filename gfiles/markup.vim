...
iabbrev <buffer> <unique> ap <c-l><cr>APPENDIX(⟦dnl _first_language_<cr>⟦⟧,<cr>dnl _next_language_<cr><c-u>⟦%%%⟧,<cr>⟧)<left><c-o>%<c-o>0<down><right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> bh BRIDGEHEAD(⟦dnl _first_language_<cr>⟦⟧,<cr>dnl _next_language_<cr><c-u>⟦%%%⟧,<cr>⟧)<left><c-o>%<c-o>0<down><right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> bq BLOCKQUOTE(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> br ⟦⟧BR()<c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> bri BRIDGEHEAD(⟦dnl _first_language_<cr>⟦⟧,<cr>dnl _next_language_<cr><c-u>⟦%%%⟧,<cr>⟧)<left><c-o>%<c-o>0<down><right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> cha <c-l><cr>CHAPTER(⟦dnl _first_language_<cr>⟦⟧,<cr>dnl _next_language_<cr><c-u>⟦%%%⟧,<cr>⟧)<left><c-o>%<c-o>0<down><right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> dld DESCRIPTION_LIST_DESC(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dldm DESCRIPTION_LIST_DESC_MONO(⟦⟦dnl monolingual<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> dlt DESCRIPTION_LIST_TERM(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> dv DIV(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> emp EMPHASIS(⟦<c-r>"⟧)<esc>
iabbrev <buffer> <unique> exc EXCL(, defn(⟦WORD_IMPORTANT⟧), ⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> fig FIGCAPTION(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> im IMAGEDATA(⟦⟧,dnl id<cr>⟦%%%⟧,dnl title<cr>⟦⟧,dnl class<cr>⟦⟧,dnl style<cr>⟦⟧,dnl anything<cr>⟦%%%, %%%⟧,dnl ⟦local_img, server_img⟧<cr>⟦⟦dnl _first_language_<cr>%%%<cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<right><right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> inf INFO(, defn(⟦WORD_INFORMATION⟧), ⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> lit LISTITEM(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)dnl LISTITEM<up><up><up><up><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> nav NAV(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> nt NOTE(, defn(⟦WORD_NOTE⟧), ⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> pa PARA(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> par PARA(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pe PERSON(⟦<c-r>"⟧)<esc>
iabbrev <buffer> <unique> plm PLAIN_TEXT_MONO(⟦⟦dnl monolingual<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pl PLAIN_TEXT(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pm PARA_MONO(⟦⟦dnl monolingual<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> pp PARA(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
"iabbrev <buffer> <unique> pp P(⟦⟧)%%%<c-o>T(<right><c-r>=Eatchar('.')<cr>
"iabbrev <buffer> <unique> prl PRE_LANG(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> scn <c-l><cr>SECT1(⟦dnl _first_language_<cr>⟦⟧,<cr>dnl _next_language_<cr><c-u>⟦%%%⟧,<cr>⟧)<left><c-o>%<c-o>0<down><right><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> sm SMALL(⟦<c-r>"⟧)<esc>
iabbrev <buffer> <unique> sp SPAN(⟦<c-r>"⟧, ⟦%%%⟧, ⟦%%%⟧)<left><c-o>%;;<c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> ss <c-l><cr>SECT1(⟦dnl _first_language_<cr>⟦⟧,<cr>dnl _next_language_<cr><c-u>⟦%%%⟧,<cr>⟧)<left><c-o>%<c-o>0<down><right><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> sum SUMMARY(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> til TILE_BOX(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> wa WARN(, defn(⟦WORD_WARNING⟧), ⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> wb ⟦⟧WBR()<c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> ww WARN(, defn(⟦WORD_WARNING⟧), ⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> xs XSPAN(⟦<c-r>"⟧, ⟦%%%⟧, ⟦%%%⟧)<left><c-o>%;;<c-r>=Eatchar('.')<cr>

iabbrev <buffer> <unique> enh ENTRY_HEAD(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> enhm ENTRY_HEAD_MONO(⟦⟦dnl monolingual<cr><cr>⟧⟧)<up><c-r>=Eatchar('.')<cr>
iabbrev <buffer> <unique> ent ENTRY(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
...
iabbrev <buffer> <unique> tti TTITLE(⟦⟦dnl _first_language_<cr><cr>⟧,<cr>⟦dnl _next_language_<cr>%%%<cr>⟧⟧)<left><c-o>%<c-o>0<down><c-r>=Eatchar('.')<cr>
