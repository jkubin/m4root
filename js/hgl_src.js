 ...
 * __REASON(⟦the source code is easier to understand when highlighted by JavaScript⟧)
 *
 * the necessary HTML attributes (data-N="…") for the JavaScript are generated by M4
 *
 * /!\ keep all variable names consistent with packer.sed
 */
...
init: function (
	...
	/*
	 * the JavaScript processes datasets from the HTML <tag data-0="…">keyword</ tag>
	 * in the following pseudo-JSON input format
	 *
	 * data-0="1"
	 * data-0="1,2,3"
	 * data-0="1-3"
