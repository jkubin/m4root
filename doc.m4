...
___DESCR(⟦extracts headers from all source files and creates short documentation⟧)
__REASON(⟦solution for cryptic short filenames⟧)
...
# for example: m4 lang_sk.m4 doc.m4 file1.m4 file2.sed file3.abc …
# for example: m4 lang_en.m4 doc.m4 file1.m4 file2.sed file3.abc …
# …
#
# file headers
...
# conversion from month numbers to months names
define(⟦01⟧, ⟦January⟧)
define(⟦02⟧, ⟦February⟧)
define(⟦03⟧, ⟦March⟧)
define(⟦04⟧, ⟦April⟧)
...
define(⟦CONVERT_DATE_TO_ANOTHER_FORMAT⟧, ⟦alias_ifdef(⟦$2⟧, ⟦__CREATION_DATE: alias_format(⟦%d⟧, ⟦$3⟧) alias_indir(⟦$2⟧) $1
⟧)⟧)

# American: month-day-year
#define(⟦CONVERT_DATE_TO_ANOTHER_FORMAT⟧, ⟦alias_ifdef(⟦$2⟧, ⟦__CREATION_DATE: alias_indir(⟦$2⟧) alias_format(⟦%d⟧, ⟦$3⟧)th, $1
#⟧)⟧)
...
⟧)alias_dnl
CONVERT_DATE_TO_ANOTHER_FORMAT($2)alias_dnl
...
# adds the total number of files at the end of all file processing
m4wrap(⟦
	alias_divert(1)alias_dnl
⟦#⟧ total number of files: alias_COUNTER_val
⟧)

# creates aliases for needed keywords (the built-in keywords will be turned off)
# A → β
