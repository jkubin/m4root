...
#:all-txt-cs/atcs	generates all ‘cs’ text and compressed files
.PHONY: all-txt-cs atcs
all-txt-cs atcs: $(TEXT_cs) $(GZIPPED_TEXT_cs) $(XZIPPED_TEXT_cs)

#:clean-txt-cs/cltcs/ctcs	deletes all ‘cs’ text and compressed files
.PHONY: clean-txt-cs cltcs ctcs
