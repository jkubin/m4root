...
define(⟦NOSCRIPT_MESSAGE⟧,	⟦Enabling JavaScript enhances the clarity of the source code samples.⟧)
...
define(⟦WORD_ARTICLE_C⟧,	⟦generated source code C⟧)
define(⟦WORD_ARTICLE_DEVELOPMENT⟧,	⟦generated html page for off-line development⟧)
define(⟦WORD_ARTICLE_MARKDOWN⟧,	⟦generated text in markdown format⟧)
define(⟦WORD_ARTICLE_PREVIEW⟧,	⟦generated html page for off-line preview⟧)
define(⟦WORD_ARTICLE_SOURCE⟧,	⟦article source code⟧)
define(⟦WORD_ARTICLE_TEXT⟧,	⟦generated text for estimating the number of characters⟧)
define(⟦WORD_CLIPBOARD⟧,	⟦select the text⟧)
...
define(⟦WORD_PUBLISH_TEXT⟧,	⟦generated text that you are currently reading and that has been entered into the content management system (CMS) of the server ⟧defn(⟦FAVORITE_SERVER_NAME⟧))
